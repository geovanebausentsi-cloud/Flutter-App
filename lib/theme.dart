...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      onSecondaryFixed: Color(0xff21182a),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff6e528b),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff7d619a),
      ...
      inverseSurface: Color(0xff332f35),
      inversePrimary: Color(0xffdabafa),
      primaryFixed: Color(0xff7d619a),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff644980),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff40265b),
      onPrimaryFixedVariant: Color(0xffffffff),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      inversePrimary: Color(0xff6e528b),
      primaryFixed: Color(0xffefdbff),
      onPrimaryFixed: Color(0xff270d43),
      primaryFixedDim: Color(0xffdabafa),
      onPrimaryFixedVariant: Color(0xff553b71),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.dark,
      primary: Color(0xffebd4ff),
      surfaceTint: Color(0xffdabafa),
      onPrimary: Color(0xff32194d),
      primaryContainer: Color(0xffa284c0),
      ...
      onSurfaceVariant: Color(0xffe2d9e4),
      outline: Color(0xffb7afba),
      outlineVariant: Color(0xff958e98),
      shadow: Color(0xff000000),
      scrim: Color(0xff000000),
      inverseSurface: Color(0xffe8e0e8),
      inversePrimary: Color(0xff563c72),
      primaryFixed: Color(0xffefdbff),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.dark,
      primary: Color(0xfff9ecff),
      surfaceTint: Color(0xffdabafa),
      onPrimary: Color(0xff000000),
      primaryContainer: Color(0xffd6b6f5),
      onPrimaryContainer: Color(0xff15002c),
      secondary: Color(0xfff9ecff),
      ...
      surfaceContainerHighest: Color(0xff4a454c),
    );
  }
